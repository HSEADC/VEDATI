...
document.addEventListener('DOMContentLoaded', function () {
  var toLibraryButton = document.getElementById('toLibrary');
  if (toLibraryButton) {
    toLibraryButton.addEventListener('click', function () {
  ...
  // Face popup
  var faceButton = document.getElementById('faceBotton');
  var popupFace = document.querySelector('.popupFace');
  if (faceButton && popupFace) {
    ...
    popupFace.addEventListener('click', function () {
  ...
  // Nkei popup
  var nkeiButton = document.getElementById('nkeiBotton');
  var popupNkei = document.querySelector('.popupNkei');
  if (nkeiButton && popupNkei) {
    nkeiButton.addEventListener('click', function () {
      popupNkei.classList.add('active');
      popupNkei.style.display = 'flex';
    });
    popupNkei.addEventListener('click', function () {
  ...
  // Toxic popup
  var toxicButton = document.getElementById('toxicBotton');
  var popupToxic = document.querySelector('.popupToxic');
  if (toxicButton && popupToxic) {
    toxicButton.addEventListener('click', function () {
      popupToxic.classList.add('active');
      popupToxic.style.display = 'flex';
    });
    popupToxic.addEventListener('click', function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Для library.html
  var toLibraryBotton = document.querySelector('#toLibrary1 #toLibraryBotton');
  if (toLibraryBotton) {
    toLibraryBotton.addEventListener('click', function () {
      window.location.href = 'library.html';
    });
  }

  // Для articles.html
  var toLibraryBottonW1 = document.querySelector('#toLibrary2 #toLibraryBottonW');
  if (toLibraryBottonW1) {
    toLibraryBottonW1.addEventListener('click', function () {
      window.location.href = 'articles.html';
    });
  }

  // Для tests.html
  var toLibraryBottonW2 = document.querySelector('#toLibrary3 #toLibraryBottonW');
  if (toLibraryBottonW2) {
    toLibraryBottonW2.addEventListener('click', function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var toArticleDiv = document.getElementById('toArticle');

  // Добавляем обработчик события "click"
  if (toArticleDiv) {
    toArticleDiv.addEventListener('click', function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var knowsDiv = document.getElementById('knows');

  // Убедимся, что knowsDiv существует
  if (knowsDiv) {
    // Находим внутри него элемент с ID toLibrary
    var toLibraryDiv = knowsDiv.querySelector('#toLibrary');

    // Добавляем обработчик клика, если элемент найден
    if (toLibraryDiv) {
      toLibraryDiv.addEventListener('click', function () {
