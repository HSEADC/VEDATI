...
root.render(/*#__PURE__*/react.createElement(src_NavBar, null));

// отправляем на 404 вместо поиска

document.querySelectorAll('.A_SearchIcon').forEach(function (icon) {
...
// меню
var burgerButton = document.querySelector('.A_BurgerButton');
var mobileMenu = document.querySelector('.M_NavMobile');
var closeButtons = document.querySelectorAll('.A_CloseIcon');
// открываем меню
...
var slides = document.querySelectorAll('.O_Slide');
var dots = document.querySelectorAll('.A_Dot');
var current = 0;
...
document.addEventListener('DOMContentLoaded', function () {
  var toLibraryBtn = document.getElementById('A_ToLibraryButton');
  var toArticlesBtn = document.getElementById('A_ToArticlesButton');
  var toTestsBtn = document.getElementById('A_ToTestsButton');
  if (toLibraryBtn) {
    toLibraryBtn.addEventListener('click', function () {
      window.location.href = 'library.html';
    });
  }
  if (toArticlesBtn) {
    toArticlesBtn.addEventListener('click', function () {
      window.location.href = 'articles.html';
    });
  }
  if (toTestsBtn) {
    toTestsBtn.addEventListener('click', function () {
